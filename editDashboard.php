...
<div class="right_col" role="main">
  <div class="x_content">
    <form action="updateDashboard.php?update=<?= $em['emId']; ?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
    ...
    <div class="item form-group">
      ...
      <div class="item form-group mt-3">
        <div class="col-md-6 col-sm-6 offset-md-3">
          <a href="dashboard.php" class="btn btn-secondary btn-sm" type="button">Cancel</a>
